...
```
npm install kalshi-typescript@3.4.0 --save
```
...
*LiveDataApi* | [**getLiveData**](docs/LiveDataApi.md#getlivedata) | **GET** /live_data/{type}/milestone/{milestone_id} | Get Live Data
