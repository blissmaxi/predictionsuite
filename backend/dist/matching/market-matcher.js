 ...
 */
import { normalizeTeamName, detectLeague } from './normalizers/sports.js';
// ============ Category Dispatching ============
/**
 * Match markets within an event based on category.
 */
export function matchMarketsWithinEvent(polymarkets, kalshiMarkets, category, eventName) {
    switch (category) {
        case 'sports':
...
// ============ Sports Matching ============
function matchSportsMarkets(polymarkets, kalshiMarkets, eventName) {
    const pairs = [];
...
function parseTemperatureRange(text) {
...
function matchWeatherMarkets(polymarkets, kalshiMarkets, eventName) {
    const pairs = [];
    // Parse all ranges
...
function matchFinanceMarkets(polymarkets, kalshiMarkets, eventName) {
    const pairs = [];
...
function formatFedAction(action) {
    if (action.type === 'hold')
        return 'Hold';
